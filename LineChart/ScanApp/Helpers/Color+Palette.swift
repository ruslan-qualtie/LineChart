...
extension Color {
    ...
    static var listRowBackground: Color { Color("geekblue-4").opacity(0.03) }
    static var listAlternateRowBackground: Color { .clear }

    // MARK: Text
    static var textSecondary: Color { Color("geekblue-3") }
    ...
    // MARK: Results Progress Bar
    static var segmentCompletedBackground: Color { Color("geekblue-3") }
    static var segmentCompletedForeground: Color { Color("geekblue-10") }
    static var segmentSkippedBackground: Color { Color("geekblue-4").opacity(0.1) }
    static var segmentSkippedForeground: Color { .white }
    ...
    // MARK: Retry or Skip Segment
    static var retryOrSkipForeground: Color { Color("geekblue-3") }
    ...
    // MARK: Survey
    static var surveyPanelBackground: Color { Color("survey-panel") }
